...
const Aboutme = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 md:max-w-5xl max-w-6xl w-full items-center mx-auto md:px-12 p-4 border border-white/20 bg-white/10 backdrop-blur-xl shadow-xl shadow-purple-500/20 rounded-xl transition z-10">
